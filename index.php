...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="my-4">Map of Noise Pollution
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="#">
            <img class="img-fluid" src="./img/en_logo.png" alt="">
          </a>
        </div>
	...
	<h3>Contact Form</h3>
	<iframe src="contact.php" width="100%"  frameborder="0" style="border:0" allowfullscreen></iframe>
	  <div class="container">
